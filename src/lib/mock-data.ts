...
export const MOCK_JOURNAL_ENTRIES: JournalEntry[] = [
  {
    ...
    metadata: { target_date: '2026-04-30', goal_status: 'active' },
    author_id: 1, author_name: 'Amy T.',
  ...
  },
  {
    ...
    metadata: { who_initiated: 'Parent', topic: 'Homework routine', outcome: 'Will break worksheets into smaller chunks', follow_up_needed: true },
    author_id: 2, author_name: 'Nicole E.',
